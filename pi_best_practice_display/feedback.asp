...
<html>
<head>
	<title>Database Answers - Best Practice Feedback</title>
</head>
...
<table border=0 cellpadding=0 cellspacing=0 width=100%>
	...
	<b>    1. What is the Topic of the Best Practice?</b><br>
	<input type="text" name="subject" value="">
	<p>
	<b>2. Please enter your comment ...</b><br>
	<textarea name="details" cols=40 rows=4></textarea>
	<p>
	<b>3. What is your email address?</b><br>
	<input type="text" name="email" value="">
	<p>
	<b>4. What is your name?</b><br>
	<input type="text" name="name" value="">
	<p>
	<b>5. What Organization are you associated with?</b><br>
	<input type="text" name="org" value="">
	<p align=center><input type="submit" value="Submit Feedback">
